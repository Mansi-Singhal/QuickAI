    ...
    return (
        <div onSubmit={onSubmitHandler} className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            ...
            <form className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
                ...
                <input onChange={(e) => setInput(e.target.files[0])} row={4} type="file" accept='image/*' className='w-full p-2 mt-2 px-3 outline-none text-sm rounded-md border border-gray-300 text-gray-600' required />
                <p className='text-xs text-gray-500 font-light mt-1'>Supports JGP, PNG, and other image formats.</p>
