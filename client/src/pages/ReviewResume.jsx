    ...
    return (
        <div onSubmit={onSubmitHandler} className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            ...
            <form className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
                ...
                <input onChange={(e) => setInput(e.target.files[0])} row={4} type="file" accept='application/pdf' className='w-full p-2 mt-2 px-3 outline-none text-sm rounded-md border border-gray-300 text-gray-600' required />
            ...
            {/* right col */}
            <div className='w-full max-w-lg p-4 bg-white rounded-lg flex-flex-col border border-gray-200 min-h-96 max-h-96 max-h-[600px]'>
                <div className='flex items-center gap-3'>
